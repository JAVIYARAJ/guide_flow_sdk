 ...
 * @property spotlightShape   Optional shape for this step's spotlight. Overrides global shape.
 * @property tag              Optional identifier for analytics or testing.
 * @property customContentLayoutRes Optional layout resource to inflate inside tooltip.
 * @property customContentView Optional custom view instance to inject inside tooltip.
 */
